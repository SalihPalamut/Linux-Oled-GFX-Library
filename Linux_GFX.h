...
public:
    Linux_GFX(int16_t w, int16_t h); // Constructor
    ...
    */
    ...
    // These exist only with Linux_GFX (no subclass overrides)
...
class Linux_GFX_Button
{

public:
    Linux_GFX_Button(void);
    // "Classic" initButton() uses center & size
    void initButton(Linux_GFX *gfx, int16_t x, int16_t y, uint16_t w,
    ...
    void initButtonUL(Linux_GFX *gfx, int16_t x1, int16_t y1, uint16_t w,
                      uint16_t h, uint16_t outline, uint16_t fill,
                      uint16_t textcolor, char *label, uint8_t textsize);
    void initButtonUL(Linux_GFX *gfx, int16_t x1, int16_t y1, uint16_t w,
                      uint16_t h, uint16_t outline, uint16_t fill,
...
class GFXcanvas1 : public Linux_GFX
{
public:
    ...
    */
    ...
    size_t getCanvasSize(void) const
    {
        return canvas_size;
    }
protected:
...
class GFXcanvas8 : public Linux_GFX
{
public:
...
class GFXcanvas16 : public Linux_GFX
{
public:
